      ...
      <DialogContent className="overflow-hidden p-0 sm:max-w-[520px]">
        ...
        <div className="px-6 pb-6">
          <DialogHeader className="-mt-6 rounded-2xl border border-zinc-200 bg-white p-5 text-left shadow-lg shadow-zinc-900/10 dark:border-[#303630] dark:bg-[#111412]">
            ...
            <DialogTitle>Teamleden uitnodigen</DialogTitle>
            <DialogDescription>
              Voeg een collega toe aan deze werkruimte zodat die kan helpen met inboxen, agents en campagnes.
            </DialogDescription>
          </DialogHeader>

          <form action={inviteAction} className="mt-5 space-y-5">
            <div className="space-y-2">
              <Label htmlFor="sidebar-invite-email">Collega uitnodigen</Label>
              <Input
              ...
              <p className="text-xs leading-5 text-muted-foreground">
                Deze persoon ontvangt een uitnodiging om mee te werken in deze werkruimte.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              {!isOwner && (
                <p className="text-xs text-amber-600">Alleen werkruimte-eigenaren kunnen teamleden uitnodigen.</p>
              )}
            </div>
