          ...
          <div className="w-full max-w-[360px] animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div className="mb-7 text-center">
              <h1 className="text-[28px] font-semibold leading-tight tracking-[-0.01em] text-zinc-950 dark:text-zinc-50">
                {show2FA ? 'Two-step verification' : mode === 'signin' ? t('welcome_back') : t('create_account')}
              </h1>
              <p className="mt-2 text-sm leading-6 text-zinc-500 dark:text-zinc-400">
                {show2FA ? 'Enter your authenticator code to continue.' : mode === 'signin' ? t('signin_desc') : t('signup_desc')}
              </p>
            </div>
              ...
              <>
                ...
                {mode === 'signup' && (
                  <p className="mt-4 text-xs leading-5 text-zinc-500 dark:text-zinc-400">
                    By continuing, you agree to Kyrn&apos;s{' '}
