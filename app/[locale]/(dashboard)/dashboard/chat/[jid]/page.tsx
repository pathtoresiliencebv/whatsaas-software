...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (!remoteJid || !currentChat?.instanceId || safeMessages.length > 0 || isLoading || error || isSyncingMessages) {
      return;
    }
  ...
  }, [remoteJid, currentChat?.instanceId, safeMessages.length, isLoading, error, isSyncingMessages]);
