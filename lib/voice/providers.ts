...
const catalog: VoiceProviderCatalog = {
  llm: [
    provider('openai', 'OpenAI', 'llm', 'ready', 'OpenAI-compatible chat completions for stable assistant reasoning.', ['apiKey'], 'gpt-4o-mini', true),
  ...
  stt: [
    ...
    provider('openai', 'OpenAI STT', 'stt', 'ready', 'OpenAI transcription for browser tests and fallback processing.', ['apiKey'], 'gpt-4o-mini-transcribe', false),
